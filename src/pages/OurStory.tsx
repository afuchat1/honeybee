        ...
        <div className="space-y-20">
            ...
            <div className="grid md:grid-cols-5 gap-8 items-start">
              ...
              <div className="md:col-span-2">
                <div className="rounded-2xl overflow-hidden">
                  <img src={impactImg} alt="Children at Honeybee Ministries" className="w-full h-auto object-cover" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-5 gap-8 items-start">
              <div className="md:col-span-2 order-2 md:order-1">
                <div className="rounded-2xl overflow-hidden">
                  <img src={founderImg} alt="Esther Awori, Founder" className="w-full h-auto object-cover" loading="lazy" />
                </div>
              </div>
              <div className="md:col-span-3 order-1 md:order-2 text-muted-foreground leading-relaxed space-y-4">
                <p>
                  Esther Awori's journey to founding Honeybee Ministries was born out of personal experience with pain, faith, and a deep conviction that every child deserves a chance. Growing up, Esther witnessed firsthand the struggles of vulnerable children in her community — children who were often invisible to the systems meant to protect them.
                </p>
                <p>
                  After years of prayer, preparation, and service in various community roles, Esther felt called to create an organization that would combine faith-based values with practical, sustainable programs. In August 2025, she officially registered Honeybee Ministries as a Community Based Organization in Buikwe District.
                </p>
                <p>
                  Her vision was simple but powerful: to build a "hive of hope" where every person — especially children with special needs and vulnerable youth — could find belonging, purpose, and a path to a brighter future. Esther's leadership continues to guide every program, partnership, and prayer that defines Honeybee Ministries.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="text-muted-foreground leading-relaxed space-y-4">
              <p>
                At its core, Honeybee Ministries is a faith story. It is the story of a God who restores broken things and calls ordinary people to extraordinary purpose. The name "Honeybee" was chosen intentionally — because bees work together, each contributing their unique role to sustain the hive. No single bee can build the hive alone.
              </p>
              <p>
                This is the spirit of our ministry. We believe that transformation happens in community — when people of faith come together with compassion, skill, and determination to serve those who need it most. Every child we support, every youth we mentor, and every family we walk alongside is a reflection of this conviction.
              </p>
            </div>
          </div>
