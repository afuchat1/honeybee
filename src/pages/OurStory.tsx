        ...
        <div className="space-y-20">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-5 gap-8 items-start">
              ...
              <div className="md:col-span-3 order-1 md:order-2 text-muted-foreground leading-relaxed space-y-6">
          ...
          {/* Faith and Restoration (unchanged, but flows naturally after the new founder section) */}
          <div>
