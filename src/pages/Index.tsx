    ...
    <>
        ...
        <div className="wide-container">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="rounded-2xl overflow-hidden">
              <img src={aboutImg} alt="Honeybee community members" className="w-full h-[380px] object-cover" loading="lazy" />
            </div>
            <div>
      ...
      <section className="section-spacing bg-muted/40">
        <div className="wide-container">
          ...
          <div className="text-center mt-12">
            <Link to="/programs" className="inline-flex items-center gap-2 text-primary font-semibold hover:underline underline-offset-4">
        ...
        <div className="wide-container">
          <div className="grid grid-cols-3 gap-2 md:gap-3">
            <div className="rounded-xl overflow-hidden aspect-[4/3]">
              <img src={programsImg} alt="Children learning" className="w-full h-full object-cover" loading="lazy" />
            </div>
            <div className="rounded-xl overflow-hidden aspect-[4/3]">
              <img src={skillsImg} alt="Youth skills training" className="w-full h-full object-cover" loading="lazy" />
            </div>
            <div className="rounded-xl overflow-hidden aspect-[4/3]">
              <img src={impactImg} alt="Happy children" className="w-full h-full object-cover" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-forest text-forest-foreground">
        <div className="wide-container text-center">
          ...
          <Link to="/impact" className="inline-flex items-center gap-2 mt-10 font-semibold opacity-90 hover:opacity-100 hover:underline underline-offset-4">
        ...
        <div className="wide-container">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Esther Awori's journey to founding Honeybee Ministries was born out of personal experience with pain, faith, and a deep conviction that every child deserves a chance. Her story of restoration and purpose is the heartbeat of this organization.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
            ...
            <div className="flex justify-center">
              <div className="rounded-2xl overflow-hidden max-w-sm">
                <img src={founderImg} alt="Esther Awori, Founder of Honeybee Ministries" className="w-full h-auto object-cover" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div className="flex justify-center order-2 md:order-1">
              <div className="w-64 h-64 md:w-72 md:h-72 rounded-full overflow-hidden">
                <img src={prayerImg} alt="Community prayer" className="w-full h-full object-cover" loading="lazy" />
              </div>
            </div>
            <div className="order-1 md:order-2">
              ...
              <Link to="/daily-prayer" className="inline-flex items-center gap-2 text-primary font-semibold hover:underline underline-offset-4">
      ...
      <section className="py-16 md:py-20 bg-forest text-forest-foreground">
        <div className="content-container text-center">
          ...
          <Link to="/vision" className="inline-flex items-center gap-2 font-semibold opacity-90 hover:opacity-100 hover:underline underline-offset-4">
